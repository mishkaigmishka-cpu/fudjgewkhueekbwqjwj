...
function showBotBattlePreview(case_type) {
    ...
    overlay.innerHTML = `
        <div class="btl-panel">
            ...
            <img src="assets/case_${case_type}.png" class="btl-case-art" alt="${getCaseName(case_type)}" onerror="this.outerHTML='<div class=&quot;btl-case-art btl-case-art-emoji&quot;>${style.icon}</div>'">
            <div class="btl-fighters">
                ...
                <img src="assets/vs.png" class="btl-vs" alt="VS" onerror="this.outerHTML='<div class=&quot;btl-vs btl-vs-text&quot;>VS</div>'">
            ...
            <div class="btl-cost">
                За битву спишется 10 <img src="assets/case_${case_type}.png" class="btl-cost-icon" alt="📦" onerror="this.outerHTML='📦'"> прогресса уровня
            </div>
            <button class="btn-game btn-primary btl-start" onclick="this.closest('#botBattlePreviewOverlay').remove(); startBotBattle('${case_type}');">
                <img src="assets/icon_battle.png" class="ic" alt="⚔️" onerror="this.outerHTML='⚔️'"> НАЧАТЬ БИТВУ
            </button>
...
function showBotRouletteAnimationWithResult(data, case_type) {
    ...
    const buildWrapper = (trackId, label, target) => `
        ...
        <div class="br-viewport">
            ...
            <img src="assets/roulette_pointer.png" class="br-pointer" alt="▼" onerror="this.outerHTML='▼'">
        </div>
    `;
    ...
    vsDiv.innerHTML = '<img src="assets/vs.png" class="br-vs-img" alt="⚔️ VS" onerror="this.outerHTML=\'<div class=&quot;br-vs-text&quot;>VS</div>\'">';
